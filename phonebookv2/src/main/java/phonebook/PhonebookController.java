...
public class PhonebookController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case "insert":
			...
			String filename=(String)files.nextElement();//name을 획득
					
			int result=service.insert(new Phonebook(
					0, 
		...
		case "update":
			...
			String filename2=(String)files2.nextElement();//name을 획득
			
			result=service.updateById(new Phonebook(
